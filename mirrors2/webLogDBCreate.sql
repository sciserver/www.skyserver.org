...
CREATE DATABASE [weblog]  ON 
  (NAME = N'weblog_Data', FILENAME = N'D:\sql_db\weblog_Data.MDF' , SIZE = 2000, FILEGROWTH = 10%)
  LOG ON (NAME = N'weblog_Log', FILENAME = N'D:\sql_db\weblog_Log.LDF' , SIZE = 1000, FILEGROWTH = 10%)
...
GO
GRANT  SELECT, INSERT 	ON SqlPerformanceLogUTC	 	TO test
GRANT  SELECT, INSERT 	ON SqlStatementLogUTC	 	TO test
GRANT  SELECT	 	ON SqlPerformanceLog	 	TO test
GRANT  SELECT	 	ON SqlStatementLog	 	TO test
